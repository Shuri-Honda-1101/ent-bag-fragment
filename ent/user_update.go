...
func (uu *UserUpdate) SetProjectID(id int) *UserUpdate {
	uu.mutation.SetProjectID(id)
	return uu
}

// SetNillableProjectID sets the "project" edge to the Project entity by ID if the given value is not nil.
func (uu *UserUpdate) SetNillableProjectID(id *int) *UserUpdate {
	if id != nil {
		uu = uu.SetProjectID(*id)
	}
	return uu
}

// SetProject sets the "project" edge to the Project entity.
func (uu *UserUpdate) SetProject(p *Project) *UserUpdate {
	return uu.SetProjectID(p.ID)
}
...
// SetProjectID sets the "project" edge to the Project entity by ID.
func (uuo *UserUpdateOne) SetProjectID(id int) *UserUpdateOne {
	uuo.mutation.SetProjectID(id)
	return uuo
}

// SetNillableProjectID sets the "project" edge to the Project entity by ID if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableProjectID(id *int) *UserUpdateOne {
	if id != nil {
		uuo = uuo.SetProjectID(*id)
	}
	return uuo
}

// SetProject sets the "project" edge to the Project entity.
func (uuo *UserUpdateOne) SetProject(p *Project) *UserUpdateOne {
	return uuo.SetProjectID(p.ID)
}
